    ...
    <>
      ...
      <section id="gallery" className="w-full flex flex-col items-center justify-start py-8 relative overflow-hidden">
        ...
        <div className="max-w-3xl text-center px-4 relative z-10">
          <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold text-orange-500 mb-4">Our Latest Work</h2>
        ...
        <div className="flex items-center gap-2 h-[400px] w-full mt-8 relative z-10">
          {images.map((src, idx) => (
            <div
              key={idx}
